...
AMAZON_IMAGE_ID = "ami-1b814f72"
KEY_PAIR_NAME = "ddrinka"
SECURITY_GROUP_ID = "sg-5ae1a233"
INSTANCE_SIZE = "c1.xlarge"

INCOMING_BITRATE = "4128k"
OUTGOING_PARAMS =[
  BitrateParam.new(2300, 1280, 720, "none"),
  BitrateParam.new(1000, 854, 480, "none"),
  BitrateParam.new(700, 710, 400, "high"),
  BitrateParam.new(400, 568, 320, "none"),
  BitrateParam.new(230, 426, 240, "none")
]
